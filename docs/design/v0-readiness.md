...
| `coproc` | a named pipe, or two redirections | Refused by name with 126, in both its forms, when it is reached (coproc.go). It needs a background job that is a process to give its pipes to; see background-processes.md |
